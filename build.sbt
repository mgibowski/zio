...
addCommandAlias("testJS", ";coreJS/test;stacktracerJS/test;streamsJS/test;testModuleJS/test")
...
lazy val streamsJVM = streams.jvm.dependsOn(testModuleJVM % "test->compile")
